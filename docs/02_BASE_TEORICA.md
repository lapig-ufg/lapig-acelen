...
Com isso, o LAPIG desenvolveu a malha fundiária ambiental, na qual integrou todas essas informações em uma base de dados única, padronizada, consistente e continuamente atualizada, permitindo uma compreensão clara da ocupação territorial. Afinal, quando a informação é estruturada e acessível, torna-se possível identificar conflitos, avaliar ativos ambientais e apoiar decisões mais sustentáveis. A malha fundiária ambiental está disponível para *download* no site ![https://malhafundiaria.lapig.iesa.ufg.br/map](https://malhafundiaria.lapig.iesa.ufg.br/map).
...
<center>
<img width="500px" title="" src="../figures/figure_2_08_1.png"/>
